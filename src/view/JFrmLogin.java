...
public class JFrmLogin extends javax.swing.JFrame {
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        UsuarioKvm usuario = new UsuarioKvm(); // Cria uma instância da classe UsuarioKvm

        String nome = jTxtNome.getText(); // Obtém o texto digitado no campo de nome  e armazena na variável 'nome'.
        String senha = jPwfSenha.getText(); // Obtém o texto digitado no campo de senha e armazena na variável 'senha'.

        Usuario_DAO usuario_DAO = new Usuario_DAO(); // Cria uma instância da classe Usuario_DAO, que é responsável pelo acesso aos dados

        boolean bola = usuario_DAO.listCadastro(nome, senha); // Chama o método 'listCadastro' para verificar se o usuário e a senha estão corretos

        System.out.println("usuario: " + usuario); // Imprime no console o objeto 'usuario'. A instância ainda não foi populada com dados do banco.

        System.out.println("nome: " + usuario.getNomeKvm()); // Tenta imprimir no console o nome do objeto 'usuario', que provavelmente será nulo.
        System.out.println("senha: " + usuario.getSenhaKvm()); // Tenta imprimir no console a senha do objeto 'usuario', que provavelmente será nula.
